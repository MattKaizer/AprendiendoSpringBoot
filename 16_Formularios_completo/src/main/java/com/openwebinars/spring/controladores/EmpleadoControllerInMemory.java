...
@Controller
public class EmpleadoControllerInMemory {
	...
	MultipartFile file) {
		...
		if (bindingresult.hasErrors()) {
			...
			if (!file.isEmpty()) {
				...
				nuevoEmpleado.setImagen(MvcUriComponentsBuilder.fromMethodName(EmpleadoControllerInMemory.class, "serveFile", avatar).build().toString());
			}
